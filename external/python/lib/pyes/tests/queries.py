...
from pyes.query import TermQuery, WildcardQuery, PrefixQuery, MatchAllQuery, \
    StringQuery, BoolQuery, FilteredQuery, FieldQuery, FieldParameter, DisMaxQuery, \
    HasChildQuery, RegexTermQuery, CustomScoreQuery
